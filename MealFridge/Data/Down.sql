ALTER TABLE [FRIDGE] DROP CONSTRAINT [Fridge_FK_Account];
ALTER TABLE [FRIDGE] DROP CONSTRAINT [Fridge_FK_Ingred];
ALTER TABLE [RESTRICTIONS] DROP CONSTRAINT [Restrictions_FK_Account];
...
ALTER TABLE [SAVEDRECIPES] DROP CONSTRAINT [SavedRecipes_FK_Account];
ALTER TABLE [SAVEDRECIPES] DROP CONSTRAINT [SavedRecipes_FK_Recipes];
ALTER TABLE [MEAL] DROP CONSTRAINT [Meal_FK_Account];
